    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card className="text-center" hover>
          ...
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white">₹{interviewer?.totalEarnings?.toLocaleString()}</h3>
        ...
        <Card className="text-center" hover>
          ...
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white">{interviewer?.rating}</h3>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            ...
            <div className="space-y-4">
              {[
                { candidate: 'John Doe', company: 'Google', category: 'A', time: '2:00 PM', date: 'Dec 28' },
                { candidate: 'Jane Smith', company: 'Microsoft', category: 'A', time: '4:00 PM', date: 'Dec 29' },
                { candidate: 'Mike Johnson', company: 'Amazon', category: 'B', time: '10:00 AM', date: 'Dec 30' }
              ].map((request, index) => (
                <div key={index} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="font-medium text-gray-900 dark:text-white">{request.candidate}</h3>
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="text-right text-sm">
                      <p className="text-gray-900 dark:text-white font-medium">{request.date}</p>
                      <p className="text-gray-500 dark:text-gray-400">{request.time}</p>
                    </div>
