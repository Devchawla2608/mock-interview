...
import {
  ...
  categoryInfo,
  timeSlots,
} from "../../components/data/sampleData";
...
function BookingFlow() {
  ...
  const handleCustomSlotConfirm = () => {
    ...
    const newSlot = {
      ...
      startTime: combinedDateTime.toLocaleTimeString([], {
        hour: "2-digit",
        minute: "2-digit",
      }),
      endTime: new Date(
        combinedDateTime.getTime() + 30 * 60000
...
=======
    ...
    bookingData["completed"] = false;
    bookingData["candidateEmail"] = JSON.parse(
      localStorage.getItem("user")
    )?.email;
    const response = await fetch(
      "http://localhost:3001/api/interview/bookInterview",
      {
        method: "POST",
>>>>>>> Stashed changes
        headers: {
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="bg-gradient-to-r from-primary-600 to-secondary-500 rounded-2xl p-8 text-white">
        ...
        <p className="text-primary-100 text-lg">
          Choose from top companies and experienced interviewers
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {categoryInfo.map((category) => (
          <Card
            ...
            className="border-2 border-transparent hover:border-primary-200 dark:hover:border-primary-800 transition-all"
            hover>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredCompanies.map((company) => (
            <Card
              key={company.id}
              className="cursor-pointer border-2 border-transparent hover:border-primary-200 dark:hover:border-primary-800 transition-all"
              hover>
      ...
      <Card>
        <div className="text-center py-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Let our AI analyze the company and recommend the best interview
            category for you
          </p>
        ...
        <div className="space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="mt-1 text-base text-gray-600 dark:text-gray-400">
              Category:{" "}
              <span className="font-medium">{bookingData.category}</span> &bull;
              ₹{bookingData.price}
            </p>
          </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900 dark:text-white">
                  {
                    categoryInfo.find(
                      (c) => c.category === bookingData.category
                    )?.duration
                  }{" "}
                  minutes
                </span>
