...
function CandidateDashboard({
  ...
  const [companyLogo, setCompanyLogo] = useState(
    "https://images.pexels.com/photos/270549/pexels-photo-270549.jpeg?auto=compress&cs=tinysrgb&w=100&h=100&fit=crop"
  );
  const [performanceData, setPerformanceData] = useState([]);
...
=======
                                    ? new Date(
                                        `1970-01-01T${interview.startTime}`
                                      ).toLocaleTimeString([], {
                                        hour: "2-digit",
                                        minute: "2-digit",
                                      })
...
=======
          ...
          <Card>
            ...
            <div className="space-y-4 max-h-[280px] overflow-y-auto pr-2 custom-scrollbar">
              {completedInterviews.map((interview) => {
                const formattedDate = interview.selectedDate
                  ? new Date(interview?.selectedDate).toLocaleDateString(
                      undefined,
                      {
                        weekday: "short",
                        year: "numeric",
